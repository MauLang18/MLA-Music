...
public class ItemImage extends javax.swing.JPanel {
    ...
    public void setData(PlaylistModel data) {
        this.data = data;
        lbTitle.setText(data.getNombre());
        lbDescription.setText(String.valueOf(data.getCount()));
        repaint();
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        if (data != null) {
            ...
            Rectangle size = getAutoSize(data.getImagen());
            g2.drawImage(toImage(data.getImagen()), size.x, size.y, size.width, size.height, null);
        }
